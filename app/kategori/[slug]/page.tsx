    ...
    return (
        ...
        >
            ...
            <div className="p-6 flex flex-col flex-1">
                <h2 className="text-xl font-bold text-slate-900 mb-3 line-clamp-2 leading-snug group-hover:text-blue-600 transition-colors">
                    {tutorial.title}
                </h2>
...
export default async function KategoriPage({ params, searchParams }: Props) {
    ...
    return (
        <main className="min-h-screen py-16 bg-slate-50">
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                {/* Hero */}
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-10 md:p-16 mb-12 text-white text-center relative overflow-hidden shadow-lg">
                    <div className="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 bg-white/10 rounded-full blur-3xl" />
                    <div className="relative z-10">
                        <Layers className="w-14 h-14 mx-auto mb-5 text-blue-200" />
