      ...
      <article className="container mx-auto px-4 max-w-4xl relative z-10 pt-10">
        ...
        <div className="bg-white dark:bg-slate-900/90 rounded-[2rem] p-8 md:p-12 shadow-xl border border-slate-200/80 dark:border-slate-800/90 backdrop-blur-xl">
          <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-headings:text-slate-900 dark:prose-headings:text-white prose-p:text-slate-600 dark:prose-p:text-slate-400 prose-a:text-blue-600 dark:prose-a:text-blue-400">
            ...
            <p>
              Situs ini mungkin menggunakan <strong>cookies</strong> dan teknologi pelacakan serupa untuk meningkatkan pengalaman pengunjung. Informasi log perangkat (seperti IP Address, jenis browser, ISP, tanggal dan waktu kunjungan, dsb.) digunakan murni untuk keperluan analitik dan tidak terhubung dengan informasi identitas personal secara langsung.
            </p>
            ...
            <ul>
              ...
              <li>Menampilkan iklan yang relevan melalui jaringan pihak ketiga (seperti Google AdSense).</li>
            </ul>

            <h2>3. Pihak Ketiga & Periklanan</h2>
            <p>
              TutorinBang bekerjasama dengan pihak ketiga seperti Google AdSense untuk menampilkan iklan. Pihak ketiga ini dapat menggunakan <em>cookies</em> (seperti cookie DART) untuk menampilkan iklan berdasarkan kunjungan Anda ke situs ini dan situs lain di internet. Anda dapat memilih untuk menonaktifkan cookie DART dengan mengunjungi kebijakan privasi jaringan iklan dan konten Google.
            </p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-2xl border border-blue-100 dark:border-blue-900/50">
              <p className="m-0 text-sm md:text-base">
                Jika Anda membutuhkan informasi lebih lanjut mengenai kebijakan privasi kami, silakan <Link href="/kontak" className="font-semibold text-blue-600 dark:text-blue-400 hover:underline">menghubungi kami di sini</Link>.
              </p>
            </div>
