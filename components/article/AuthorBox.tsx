...
export default function AuthorBox() {
  return (
    <div className="flex bg-slate-50 dark:bg-slate-900 rounded-xl p-6 mt-12 gap-5 items-start border border-slate-100 dark:border-slate-800">
      <div className="w-16 h-16 relative rounded-full bg-slate-300 dark:bg-slate-700 overflow-hidden flex-shrink-0 border-2 border-white dark:border-slate-800 shadow-sm flex items-center justify-center">
        <Image
          src={tutorinLogo}
