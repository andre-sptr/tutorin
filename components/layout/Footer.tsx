...
export default function Footer() {
    return (
        <footer className="relative bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 pt-10 md:pt-20 pb-6 md:pb-10 overflow-hidden">
            ...
            <div className="container mx-auto px-4 max-w-7xl relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-12 mb-8 md:mb-16">
                    <div className="lg:col-span-5">
                        <Link href="/" className="font-extrabold text-2xl md:text-3xl tracking-tight text-slate-900 dark:text-white mb-3 md:mb-6 inline-flex items-center gap-2 group">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm mb-4 md:mb-8 max-w-md">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-5 md:gap-8 lg:gap-12">
                        <div>
                            <h3 className="font-extrabold text-slate-900 dark:text-white mb-3 md:mb-6 uppercase tracking-wider text-xs md:text-sm">Eksplorasi</h3>
                        ...
                        <div>
                            <h3 className="font-extrabold text-slate-900 dark:text-white mb-3 md:mb-6 uppercase tracking-wider text-xs md:text-sm">Platform</h3>
                            <ul className="space-y-2 md:space-y-4">
                        ...
                        <div className="col-span-2 sm:col-span-1 border-t sm:border-0 border-slate-100 dark:border-slate-800 pt-6 sm:pt-0">
                            <h3 className="font-extrabold text-slate-900 dark:text-white mb-3 md:mb-6 uppercase tracking-wider text-xs md:text-sm">Kebijakan</h3>
                            <ul className="space-y-2 md:space-y-4">
                ...
                <div className="pt-6 md:pt-8 border-t border-slate-200/80 dark:border-slate-800/80 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6 pb-2">
                    ...
                    <div className="flex items-center gap-2 text-xs md:text-sm font-bold text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-900 px-4 md:px-5 py-2 md:py-2.5 rounded-full border border-slate-200 dark:border-slate-800 shadow-sm cursor-default hover:border-slate-300 dark:hover:border-slate-700 transition-colors text-center shrink-0">
                        Didesain dengan <Heart className="w-3.5 h-3.5 md:w-4 md:h-4 text-red-500 fill-red-500" /> di Indonesia
                    </div>
                </div>
            </div>
        </footer>
